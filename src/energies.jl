...
function potential_energy(dp::DoublePendulum)
    """
    Calculate the potential energy (P) of the system.
...
function total_energy(dp::DoublePendulum)
    """
    Calculate the total mechanical energy (E = T + P) of the system.
    Source: https://en.wikipedia.org/wiki/Mechanical_energy
