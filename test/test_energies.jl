...
@testset "Energy Tests" begin
    ...
    @testset "Total Energy (E)" begin
        ...
        @test kinetic_energy(dp_combo) ≈ 2.5
        @test potential_energy(dp_combo) ≈ -30.0
        @test total_energy(dp_combo) ≈ -27.5
    end
end